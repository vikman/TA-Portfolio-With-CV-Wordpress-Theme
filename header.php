...
<!-- Vcard -->
<link rel="stylesheet" id="styles-css" href="<?php echo get_template_directory_uri(); ?>/vcard/style.css" type="text/css" media="all">
<!--<link rel="stylesheet" id="reset-css" href="<?php echo get_template_directory_uri(); ?>/vcard/bootstrap.min.css" type="text/css" media="all">
<link rel="stylesheet" id="responsive-css" href="<?php echo get_template_directory_uri(); ?>/vcard/font-awesome.min.css" type="text/css" media="all">

<link rel="stylesheet" id="mytheme-opensans-css" href="<?php echo get_template_directory_uri(); ?>/vcard/css" type="text/css" media="all">-->
<?php wp_head(); ?>
</head>
