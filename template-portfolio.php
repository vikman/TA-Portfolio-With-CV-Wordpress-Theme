...
get_header(); ?>
<?php $addinheader = "";
if ( ta_option( 'header_image_background' ) != '' && strlen(ta_option( 'header_image_background' ) )>0) :
	$addinheader = " style='background: url(".ta_option( 'header_image_background', false, 'url' ).")'"; 
endif; ?>
	<!-- Portfolio Header -->
    <header class="portfolio-header"<?php echo $addinheader; ?>>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
